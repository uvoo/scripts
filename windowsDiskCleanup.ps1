...
#branchcache flush
# Requested by Alex Widner
# Reference
# https://social.technet.microsoft.com/Forums/en-US/7502e46d-0145-4aeb-816c-c2e2101ec232/large-files-on-disc-c-win-srv2012-r2-cwindowsserviceprofilesnetworkservice?forum=winserveressentials
